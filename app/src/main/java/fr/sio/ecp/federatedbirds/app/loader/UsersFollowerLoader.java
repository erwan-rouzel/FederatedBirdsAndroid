 ...
 */
public class UsersFollowerLoader extends UsersLoader {

    public UsersFollowerLoader(Context context, Long userId) {
        super(context, userId);
    }

    @Override
    protected List<User> getUsers(Long userId) throws IOException, ApiException {
        return ApiClient.getInstance(getContext()).getUserFollower(userId);
    }
